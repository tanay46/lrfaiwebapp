...
artistmap = {'Banksy':'banksy', 'Andy Warhol':'andywarholpaintings','Agnes Martin':'Agnes-Martin', 'Roy Lichtenstein':'roylichtenstein1','Keith Haring':'Keith-Haring'}
valuestr = ''
...
def facebook(artist):
	...
	for i in range(0, len(dates)-1):
		req = urllib2.Request("https://graph.facebook.com/" + artistmap[artist] + "/insights?since=1-" +dates[i]+ "&until=2-" +dates[i]+ "&access_token=1388859028003148|7ec5645154cf6a5ea978b5e710f784b0")
		...
		req = urllib2.Request("https://graph.facebook.com/" + artistmap[artist] + "/insights?since=1-" +dates[i+1]+ "&until=2-" +dates[i+1]+ "&access_token=1388859028003148|7ec5645154cf6a5ea978b5e710f784b0")
		response = urllib2.urlopen(req)
